...
/**
 * Placeholder for the real RATECARD-backed lookup (task 5.4, docs/lld/pricing-service.md).
 * Returns a fixed price/SLA per parcel type so Order Service's creation flow
 * and tests aren't blocked on Pricing's implementation.
 */
@Injectable()
