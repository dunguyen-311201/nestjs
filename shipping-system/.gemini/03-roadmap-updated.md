# Simplified Implementation Roadmap & Estimation

This document defines the structured roadmap and time estimates for implementing the simplified Shipping System vertical slice in local development.
...
| :--- | :--- | :--- | :--- |
| **Day 1** | **M1: Core Order Intake** | Scaffolding, Postgres setup, and `CreateOrder` logic (Article price locking). | 1.5 |
...
### Day 7-8: Giao Chặng Cuối & Hoàn Hàng (RTS)
